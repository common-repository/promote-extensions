...
if ( !class_exists( 'promote_client_widget' ) ) {

	class promote_client_widget extends WP_Widget {

		public function __construct() {
			parent::__construct(
				'promote-client-widget',
				__( 'Promote - Clients widget', 'promote' ),
				array(
		 ...
		 */
		 function widget($args, $instance) {
				 ...
				 extract($args);
 			 $promote_checkbox_var = isset( $instance['promote_checkbox_var'] ) ? $instance['promote_checkbox_var'] : '';
				 echo $before_widget;
					 ...
					 <ul class=" text-center">
						 <?php if( !empty($instance['image_uri1']) ): ?>
							 ...
							 <li class="large-2 large-centered medium-3 medium-centered small-4  columns mb35 wow animated fadeIn">
								 <a <?php if( !empty($instance['client_uri1']) ):?> href="<?php echo esc_url($instance['client_uri1']);?>" <?php endif;?> <?php  if( 'on' == $promote_checkbox_var ) : ?> target="_blank" <?php endif;?> >
						 ...
						 <?php if( !empty($instance['image_uri2']) ): ?>
							 <!-- client one start -->
							 <li class="large-2 large-centered medium-3 medium-centered small-4  columns mb35 wow animated fadeIn">
								 <a <?php if( !empty($instance['client_uri2']) ):?> href="<?php echo esc_url($instance['client_uri2']);?>" <?php endif;?> <?php  if( 'on' == $promote_checkbox_var ) : ?> target="_blank" <?php endif;?> >
						 ...
						 <?php if( !empty($instance['image_uri3']) ): ?>
							 <!-- client three start -->
							 <li class="large-2 large-centered medium-3 medium-centered small-4  columns mb35 wow animated fadeIn">
								 <a <?php if( !empty($instance['client_uri3']) ):?> href="<?php echo esc_url($instance['client_uri3']);?>" <?php endif;?> <?php  if( 'on' == $promote_checkbox_var ) : ?> target="_blank" <?php endif;?>>
						 ...
						 <?php if( !empty($instance['image_uri4']) ): ?>
							 <!-- client four start -->
							 <li class="large-2 large-centered medium-3 medium-centered small-4  columns mb35 wow animated fadeIn">
								 <a <?php if( !empty($instance['client_uri4']) ):?> href="<?php echo esc_url($instance['client_uri4']);?>" <?php endif;?> <?php  if( 'on' == $promote_checkbox_var ) : ?> target="_blank" <?php endif;?>>
						 ...
						 <?php if( !empty($instance['image_uri5']) ): ?>
							 <!-- client five start -->
							 <li class="large-2 large-centered medium-3 medium-centered small-4  columns mb35 wow animated fadeIn">
								 <a <?php if( !empty($instance['client_uri5']) ):?> href="<?php echo esc_url($instance['client_uri5']);?>" <?php endif;?> <?php  if( 'on' == $promote_checkbox_var ) : ?> target="_blank" <?php endif;?> >
 ...
 <?php
		 ...
		 $instance[ 'promote_checkbox_var' ] = strip_tags($new_instance[ 'promote_checkbox_var' ]);
 ...
 <div class="accordion_promote">
				...
				<h4 > <?php _e('Client 1', 'promote-extensions') ?></h4>
				 <div class="pane_promote">
						 <div class="widget_input_wrap">
								 <label for="<?php echo $this->get_field_id( 'image_uri1' ); ?>"><?php _e('Image 1', 'promote-extensions') ?></label>
								 ...
								 <a class="media-picker-button button" onclick="mediaPicker(this.id)" id="<?php echo $this->get_field_id( 'image_uri1' ).'mpick'; ?>"><?php _e('Select Image', 'promote-extensions') ?></a>
								 </div>
										 </div>
			 ...
			 <label for="<?php echo $this->get_field_id('client_uri1'); ?>"><?php _e('Link 1','promote-extensions'); ?></label><br />
			 <input type="text" name="<?php echo $this->get_field_name('client_uri1'); ?>" id="<?php echo $this->get_field_id('client_uri1'); ?>" value="<?php if( !empty($instance['client_uri1']) ): echo esc_url($instance['client_uri1']); endif; ?>" class="widefat">
				 ...
				 <!--- Client 2-->
				<h4><?php _e('Client 2', 'promote-extensions') ?></h4>


 <div class="pane_promote">
						 <div class="widget_input_wrap">
								 <label for="<?php echo $this->get_field_id( 'image_uri2' ); ?>"><?php _e('Image 2', 'promote-extensions') ?></label>
								 <div class="media-picker-wrap">
								 <?php if(!empty($instance['image_uri2'])) { ?>
								 ...
								 <a class="media-picker-button button" onclick="mediaPicker(this.id)" id="<?php echo $this->get_field_id( 'image_uri2' ).'mpick'; ?>"><?php _e('Select Image', 'promote-extensions') ?></a>
								 </div>
						 </div>
			 ...
			 <label for="<?php echo $this->get_field_id('client_uri2'); ?>"><?php _e('Link 2','promote-extensions'); ?></label><br />
 ...
 <h4 > <?php _e('Client 3', 'promote-extensions') ?></h4>
 <div class="pane_promote">

						 <div class="widget_input_wrap">
								 <label for="<?php echo $this->get_field_id( 'image_uri3' ); ?>"><?php _e('Image 3', 'promote-extensions') ?></label>
								 <div class="media-picker-wrap">
								 <?php if(!empty($instance['image_uri3'])) { ?>
								 ...
								 <a class="media-picker-button button" onclick="mediaPicker(this.id)" id="<?php echo $this->get_field_id( 'image_uri3' ).'mpick'; ?>"><?php _e('Select Image', 'promote-extensions') ?></a>
								 </div>
						 </div>
			 ...
			 <label for="<?php echo $this->get_field_id('client_uri3'); ?>"><?php _e('Link 3','promote-extensions'); ?></label><br />
 ...
 <h4 > <?php _e('Client 4', 'promote-extensions') ?></h4>
 <div class="pane_promote">

						 <div class="widget_input_wrap">
								 <label for="<?php echo $this->get_field_id( 'image_uri4' ); ?>"><?php _e('Image 4', 'promote-extensions') ?></label>
								 <div class="media-picker-wrap">
								 <?php if(!empty($instance['image_uri4'])) { ?>
								 ...
								 <a class="media-picker-button button" onclick="mediaPicker(this.id)" id="<?php echo $this->get_field_id( 'image_uri4' ).'mpick'; ?>"><?php _e('Select Image', 'promote-extensions') ?></a>
								 </div>
						 </div>
			 ...
			 <label for="<?php echo $this->get_field_id('client_uri4'); ?>"><?php _e('Link 4','promote-extensions'); ?></label><br />
			 <input type="text" name="<?php echo $this->get_field_name('client_uri4'); ?>" id="<?php echo $this->get_field_id('client_uri4'); ?>" value="<?php if( !empty($instance['client_uri4']) ): echo esc_url($instance['client_uri4']); endif; ?>" class="widefat">
						...
						<!--- Client 5-->
						 ...
						 <h4 > <?php _e('Client 5', 'promote-extensions') ?></h4>

 <div class="pane_promote">
						 <div class="widget_input_wrap">
								 <label for="<?php echo $this->get_field_id( 'image_uri5' ); ?>"><?php _e('Image 5', 'promote-extensions') ?></label>
								 <div class="media-picker-wrap">
								 <?php if(!empty($instance['image_uri5'])) { ?>
								 ...
								 <a class="media-picker-button button" onclick="mediaPicker(this.id)" id="<?php echo $this->get_field_id( 'image_uri5' ).'mpick'; ?>"><?php _e('Select Image', 'promote-extensions') ?></a>
								 </div>
						 </div>
			 ...
			 <label for="<?php echo $this->get_field_id('client_uri5'); ?>"><?php _e('Link 5','promote-extensions'); ?></label><br />
	 ...
	 <p>
	     <input class="checkbox" type="checkbox" <?php checked( $instance[ 'promote_checkbox_var' ], 'on' ); ?> id="<?php echo $this->get_field_id( 'promote_checkbox_var' ); ?>" name="<?php echo $this->get_field_name( 'promote_checkbox_var' ); ?>" />
	     <label for="<?php echo $this->get_field_id( 'promote_checkbox_var' ); ?>"><?php _e('Open In new tab', 'promote'); ?></label>
	 </p>
			<?php
